...
stdout.write(
  'Приветствую! Введите, пожалуйста, текст! Он будет записываться в файл file.txt до тех пор, пока вы не завершите исполнение программы.\n',
);
...
// для запуска кода используйте в консоли: node 02-write-file или с помощью расширения в VsCode: Code Runner
